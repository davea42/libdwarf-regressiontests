...
{
  static const CRCDATATYPE crc32_table[256] =
    {
...
static void
dump_bytes(const char * msg,unsigned char *  start, unsigned long len)
{
...
int main()
{
    ...
    while (remaining > 0) {
        ...
        revcrc =  gnu_debuglink_crc32 (crc, readbuf, readsize);
        crc = revcrc;
        remaining -= readsize;
    }
