...
onetest "-group 4" $testsrc/debugfission/archive.o junk.sgtest2out
echo "There is no group 2 in archive.o, init gets NO ENTRY" >>junk.sgtest2out 
...
echo "There is no group 2 in example.o so it is NO ENTRY" >>junk.sgtest2out
...
echo "There is no group 5 in example.o but it is chosen." >>junk.sgtest2out
