...
Libdwarf no longer does abort() in any circumstance.
If there is an error and no error handler is available
it will print a one-line message on stderr and
libdwarf will return a DW_DLV_ERROR value
