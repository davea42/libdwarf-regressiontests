...
between some ALLdd instances easier as it eliminates
the timestamp noise.
Useful if two machines get different pass/fail counts
so one does diff or fldiff on the pair of ALLdd
files.
"""
